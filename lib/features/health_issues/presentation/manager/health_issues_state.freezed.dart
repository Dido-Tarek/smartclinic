...
part of 'health_issues_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HealthIssuesState<T>);
}
...
/// @nodoc
class $HealthIssuesStateCopyWith<T,$Res>  {
$HealthIssuesStateCopyWith(HealthIssuesState<T> _, $Res Function(HealthIssuesState<T>) __);
}


/// Adds pattern-matching-related methods to [HealthIssuesState].
extension HealthIssuesStatePatterns<T> on HealthIssuesState<T> {
...
class _Initial<T> implements HealthIssuesState<T> {
  const _Initial();
...
@override
String toString() {
  return 'HealthIssuesState<$T>.initial()';
}
...
class _Loading<T> implements HealthIssuesState<T> {
  const _Loading();
...
@override
String toString() {
  return 'HealthIssuesState<$T>.loading()';
}
...
class _Success<T> implements HealthIssuesState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of HealthIssuesState
...
@override
String toString() {
  return 'HealthIssuesState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $HealthIssuesStateCopyWith<T, $Res> {
...
class _Error<T> implements HealthIssuesState<T> {
...
@override
String toString() {
  return 'HealthIssuesState<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $HealthIssuesStateCopyWith<T, $Res> {
