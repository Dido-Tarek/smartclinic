...
part of 'upload_credentials_state.dart';
...
/// @nodoc
mixin _$UploadCredentialsState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UploadCredentialsState<T>);
}
...
@override
String toString() {
  return 'UploadCredentialsState<$T>()';
}
...
/// @nodoc
class $UploadCredentialsStateCopyWith<T,$Res>  {
$UploadCredentialsStateCopyWith(UploadCredentialsState<T> _, $Res Function(UploadCredentialsState<T>) __);
}


/// Adds pattern-matching-related methods to [UploadCredentialsState].
extension UploadCredentialsStatePatterns<T> on UploadCredentialsState<T> {
...
class _Initial<T> implements UploadCredentialsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'UploadCredentialsState<$T>.initial()';
}
...
class Loading<T> implements UploadCredentialsState<T> {
  const Loading();
...
@override
String toString() {
  return 'UploadCredentialsState<$T>.loading()';
}
...
class Success<T> implements UploadCredentialsState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of UploadCredentialsState
...
@override
String toString() {
  return 'UploadCredentialsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UploadCredentialsStateCopyWith<T, $Res> {
...
class Error<T> implements UploadCredentialsState<T> {
...
@override
String toString() {
  return 'UploadCredentialsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UploadCredentialsStateCopyWith<T, $Res> {
