...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddClinicState<T>);
}
...
/// @nodoc
class $AddClinicStateCopyWith<T,$Res>  {
$AddClinicStateCopyWith(AddClinicState<T> _, $Res Function(AddClinicState<T>) __);
}


/// Adds pattern-matching-related methods to [AddClinicState].
extension AddClinicStatePatterns<T> on AddClinicState<T> {
...
class _Initial<T> implements AddClinicState<T> {
  const _Initial();
...
@override
String toString() {
  return 'AddClinicState<$T>.initial()';
}
...
class Loading<T> implements AddClinicState<T> {
  const Loading();
...
@override
String toString() {
  return 'AddClinicState<$T>.loading()';
}
...
class Success<T> implements AddClinicState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AddClinicState
...
@override
String toString() {
  return 'AddClinicState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AddClinicStateCopyWith<T, $Res> {
...
class Error<T> implements AddClinicState<T> {
...
@override
String toString() {
  return 'AddClinicState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $AddClinicStateCopyWith<T, $Res> {
