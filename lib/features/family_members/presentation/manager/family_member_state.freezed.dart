...
part of 'family_member_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FamilyState<T>);
}
...
/// @nodoc
class $FamilyStateCopyWith<T,$Res>  {
$FamilyStateCopyWith(FamilyState<T> _, $Res Function(FamilyState<T>) __);
}


/// Adds pattern-matching-related methods to [FamilyState].
extension FamilyStatePatterns<T> on FamilyState<T> {
...
class _Initial<T> implements FamilyState<T> {
  const _Initial();
...
class _Loading<T> implements FamilyState<T> {
  const _Loading();
...
class _Success<T> implements FamilyState<T> {
...
@override
String toString() {
  return 'FamilyState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $FamilyStateCopyWith<T, $Res> {
...
class _Error<T> implements FamilyState<T> {
...
@override
String toString() {
  return 'FamilyState<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $FamilyStateCopyWith<T, $Res> {
